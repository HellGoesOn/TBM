...
namespace TBM
{
    public static class Utils
    {
        ...
        {
            projectile.velocity = Utils.DistanceToMouse(p, vel);
            projectile.position = p.position + Utils.DistanceToMouse(p, vel);
            projectile.Center = p.MountedCenter + Utils.DistanceToMouse(p, vel);
        }
